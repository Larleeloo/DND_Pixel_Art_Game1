...
public class PlayableCharacter {
    ...
    public java.awt.Color getRarityColor() {
        switch (rarity) {
            ...
            case UNCOMMON: return new java.awt.Color(50, 205, 50); // Green
            case RARE: return new java.awt.Color(30, 144, 255); // Blue
            case EPIC: return new java.awt.Color(148, 0, 211); // Purple
            case LEGENDARY: return new java.awt.Color(255, 165, 0); // Orange
            case MYTHIC: return new java.awt.Color(0, 255, 255); // Cyan
