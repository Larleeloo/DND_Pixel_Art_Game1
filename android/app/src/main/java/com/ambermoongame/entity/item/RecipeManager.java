 ...
 *
 * Conversion notes:
 * - java.nio.file.Files.readAllBytes(Paths.get()) -> Context.getAssets().open() + InputStream
 * - System.out/err.println                        -> Log.d()/Log.e()
 * - File path "data/alchemy_recipes.json"          -> Android asset "data/alchemy_recipes.json"
 *
